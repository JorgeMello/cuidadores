      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Total de Cuidadores</span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Tipos de Cuidadores</span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Expiração em Breve</span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Total de Receita</span>
        ...
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Novos Cuidadores</span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Cuidadores Expirados</span>
        ...
        <div class="row">
          ...
          <div class="card">
            ...
            <h3 class="card-title">Novos Cuidadores</h3>
    ...
    <div class="card-body p-0">
        <ul class="products-list product-list-in-card pl-2 pr-2">
            ...
            while ($row = $recentMembersResult->fetch_assoc()) {
                ...
                echo 'Número da Matrícula: ' . ($row['membership_number']); 
                echo '</span>';
                echo '</div>';
                echo '</li>';
            }
