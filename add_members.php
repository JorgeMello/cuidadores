                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-keyboard"></i> Adicionar Cuidador</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form method="post" action="" enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-sm-6">
                                            <label for="contactNumber">Telefone</label>
                                    ...
                                    <div class="row mt-3">
                                    <div class="col-sm-6">
                                        <label for="membershipType">Categoria</label>
                                    ...
                                    <div class="col-sm-6">
                                        <label for="photo">Fotografia do Rosto</label>
