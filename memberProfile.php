                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Perfil do Cuidador</h3>
                            <!-- Add Print Button -->
                            <div class="card-tools">
                                ...
                                <a href="print_membership_card.php?id=<?php echo $memberId; ?>" target="_blank" class="btn btn-tool">
                                    <i class="fas fa-external-link-alt"></i> Carteira do Cuidador
                                </a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-5">
                                    <p><strong>Matrícula:</strong> <?php echo $memberDetails['membership_number']; ?></p>
                                    <p><strong>Nome:</strong> <?php echo $memberDetails['fullname']; ?></p>
                                    <p><strong>Data de Nascimento:</strong> <?php echo $memberDetails['dob']; ?></p>
                                    <p><strong>Sexo:</strong> <?php echo $memberDetails['gender']; ?></p>
                                    <p><strong>Telefone:</strong> <?php echo $memberDetails['contact_number']; ?></p>
                                    <p><strong>Email:</strong> <?php echo $memberDetails['email']; ?></p>
                                </div>
                                <div class="col-md-5">
                                    <p><strong>Endereço:</strong> <?php echo $memberDetails['address']; ?></p>
                                    <p><strong>Cidade:</strong> <?php echo $memberDetails['country']; ?></p>
                                    <p><strong>CEP:</strong> <?php echo $memberDetails['postcode']; ?></p>
                                    <p><strong>Ocupação:</strong> <?php echo $memberDetails['occupation']; ?></p>
                                    <p><strong>Categoria:</strong> <?php echo $memberDetails['membership_type_name']; ?></p>
                                ...
                                <a href="print_membership_card.php?id=<?php echo $memberId; ?>" target="_blank" class="print-button"><button class="btn btn-info"><i class="fas fa-id-card"></i> Carteira do Cuidador</button></a>
